...
lable_0 = Label(root, text="  CURRENT WEATHER  ", anchor='e', font=("comic sans", 48, "bold",), bg='lawn green', fg='black',
                bd=7, relief='raised')
...
lable_1 = Label(root, text=" Minimum Temperature : ", width=20, font=("comic sans", 17), fg='light yellow',
                bg='dark green', borderwidth=3, relief="raised")
lable_1.place(x=110, y=310)

lable_6 = Label(root, text="Maximum Temperature : ", width=20, font=("comic sans", 17), fg='light yellow',
                bg='dark green', borderwidth=3, relief="raised")
lable_6.place(x=110, y=380)

lable_2 = Label(root, text="Temperature : ", width=20, font=("comic sans", 17), fg='light yellow', bg='dark green',
                borderwidth=3, relief="raised")
lable_2.place(x=110, y=450)

lable_3 = Label(root, text="Wind Speed : ", width=20, font=("comic sans", 17), fg='light yellow', bg='dark green',
                borderwidth=3, relief="raised")
lable_3.place(x=750, y=310)

lable_5 = Label(root, text="Humidity : ", width=20, font=("comic sans", 17), fg='light yellow', bg='dark green',
                borderwidth=3, relief="raised")
lable_5.place(x=750, y=380)

lable_8 = Label(root, text="Pressure : ", width=20, font=("comic sans", 17), fg='light yellow', bg='dark green',
                borderwidth=3, relief="raised")
lable_8.place(x=750, y=450)

lable_9 = Label(root, text=" Description :", width=20, font=("comic sans", 17), fg='light yellow', bg='dark green',
                borderwidth=3, relief="raised")
...
# api config
def getTemp():
    owm = pyowm.OWM('b04e5c43bf8ba74910c8d5265a0e')
...
Button(root, text="SUBMIT", width=15, font=("comic sans", 13), bg='maroon', fg='white', bd=9, command=getTemp).place(
    x=590, y=235)
